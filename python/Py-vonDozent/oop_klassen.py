...
class Monitor:
    ...
    # größe
    # __eq__ gibt es auch in der Elternklasse object 
    # __eq__ in object vergleicht Referenzen
    # __eq__ in dieser Klasse sorgt für einen inhaltlichen Vergleich
    # monitor1 == monitor2 (hier: value)
...
mon4 = mon2 # Zuweisung ist nun string, NICHT MEHR REFERENZ 
print("Mon4: ", mon4)
